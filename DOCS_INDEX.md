...
| 文档 | 内容 | 说明 |
|------|------|------|
| `AGENTS.md` | 经验库规则、项目简介、模块边界、架构原则、构建 / 验证命令、环境 / 依赖、开发规范（压缩版）、领域决策索引、关键约束 | **唯一常驻**。2026-09 重写：订正单位体系（内部 mm / 显示 cm）、用例数（61 = 54 + 7 守卫）、缩放常量、模块表补 `src/document`；细节一律按需查对应档案 |
