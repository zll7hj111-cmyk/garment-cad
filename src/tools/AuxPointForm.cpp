    ...
    : QWidget(parent)
{
    ...
    m_editPercent = new QLineEdit(this);
    ...
    m_editConstant = new QLineEdit(this);
    ...
    auto makePasteBtn = [this](QLineEdit* edit) {
        auto* btn = new QPushButton(QStringLiteral("填入"), this);
    ...
    m_editOffsetAngle = new QLineEdit(this);
    ...
    m_editOffsetDist = new QLineEdit(this);
