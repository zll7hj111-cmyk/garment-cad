...
public:
    ...
    /// Update incoming mount info (other segments attached to this aux point).
    void setMountInfo(const QString& info, bool hasIncoming, bool isDetached);
...
signals:
    ...
    /// User clicked the detach/reconnect button for incoming mounts.
